...
const ConsHospitalStrip: React.FC = () => {
    ...
    if (file) {
      ...
      try {
        const response = await axios.post(
          'https://bongsapi.dpanalyticsolution.com/api/v1/consumable/hospital/import',
          formData,
          {
            headers: {
  ...
  const handleExport = async (format: string) => {
    ...
    try {
      const response = await axios.get(
        'https://bongsapi.dpanalyticsolution.com/api/v1/consumable/hospital/export',
        {
          params: { format },
          responseType: 'blob',
          headers: {
      ...
      <div className="flex items-center gap-3">
        <button
          ...
          onClick={() => {
            ...
            dispatch(toggleAddConsumeablesModal('Hospital'));
          }}
        >
          Add Hospital
        </button>
...
export default ConsHospitalStrip;
