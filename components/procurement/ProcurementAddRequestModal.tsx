...
function ProcurementAddRequestModal({
  ...
  useEffect(() => {
    ...
    setMinDate(today);
    setRFQType(procurementType);
    setSelectedDepartment(departmentId);
    setSelectedCategory(vendor_category);
    const numberString = budget?.replace(/[^\d.-]/g, "");
    setAmount(parseFloat(numberString));
    setStartDate(bidding_deadline);
    ...
    <>
      <div className="mb-3">
        ...
        <input
          ...
          className="bg-gray-50 border border-gray-300 w-full text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  p-3 flex-1"
        />
      </div>
      <div className=" ">
        {attachedImage && (
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-1">
              <div>
                ...
                <select
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500  p-3 w-full mb-2"
                >
              ...
              <div className="mt-2">
                ...
                <div className="w-full h-[45px] rounded-[10px] border border-black/50 flex items-center px-2 flex-row space-x-2">
            ...
            <table className="">
              <thead>
                <tr>
                  ...
                  <td className="text-center text-black">Remark</td>
              ...
              <tbody>
                {draftList.map((list: any, index: number) => (
                  <tr key={index}>
                    ...
                    <td className="text-center text-sm">{list.part_number}</td>
                    <td className="text-center text-sm">
                      {list.model_number || ""}
                    </td>
                    <td className="text-center text-sm">{list.remark}</td>
                    <td>
                    ...
                    <td className="flex flex-row items-center justify-center space-x-2 h-full">
                      <button
